<?php
    class Langue_EN extends Language
    {
        public function __construct()
        {
            ...
            self::addDialog($l, 'login_dialog', 'Don\'t have an Account? Go <a h>register!');
            self::addDialog($l, 'login_dialog_modal', 'Don\'t have an Account? Goto the registration tab above!');
            self::addDialog($l, 'register_dialog', 'Already have an Account? Goto the login tab above!');
            self::addDialog($l, 'register_dialog_modal', 'Already have an Account? Goto the login tab above!');
